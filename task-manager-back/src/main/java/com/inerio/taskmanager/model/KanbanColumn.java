...
/**
 * Entity representing a Kanban column (e.g. "To Do", "In Progress").
 * <p>
 * Each KanbanColumn is a column on the board containing multiple {@link Task} entities.
...
public class KanbanColumn {
    ...
    /** Unique identifier for the column (autogenerated by the database). */
    @Id
     ...
     * <p>
     * Cascade ALL: when a column is deleted, all its tasks are deleted too.<br>
     * OrphanRemoval: ensures DB stays clean if tasks are removed from the column.<br>
    ...
    /**
     * Full constructor for creating a KanbanColumn with name and position.
     *
    ...
    /**
     * Add a task to this column and set the reverse relation.
     * <p>
    ...
    /**
     * Remove a task from this column and clear its reference.
